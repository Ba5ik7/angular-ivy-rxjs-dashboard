...
export class SidePanelService {
  ...
  public sidePanelToggle$: Observable<
    boolean
  > = this._sidePanelToggle.asObservable();
  ...
  public sidePanelOpen$: Observable<
    boolean
  > = this._sidePanelOpen.asObservable();
  ...
  public sidePanelClose$: Observable<
    boolean
  > = this._sidePanelClose.asObservable();
